...
public class TestData {
    ...
    public ArrayList<BalanceEntity> listBalance;
    ...
    public TestData() throws InterruptedException {
        ...
        BigDecimal oldBalance = new BigDecimal(324.54);

        BalanceEntity balanceEntity = new BalanceEntity(oldBalance, beforeDate, ilya);
